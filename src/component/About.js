import { Box, Button, Center, Container, Flex, Grid, Text, createStyles } from '@mantine/core'
...
export default function About() {
    ...
    return (
        <>
         <NavBar />
            <Box id='about' className={classes.mainBox}>

                <Grid m={0}>
                    <Grid.Col p={0} m={0} md={6} >
                        <Box className={classes.aboutBox1}>
                            <Text>About    Fly Right   <br />  Movers  </Text>
                        </Box>
                    </Grid.Col >
